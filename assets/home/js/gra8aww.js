...
/*{"k":"1.6.1","auto_updating":true,"last_published":"2021-01-23 01:45:45 UTC"}*/
(function(config) {
    (function() {
        'use strict';
        var f, g = [];
        ...
        function n(a) {
            ...
            this.f = [];
            var b = this;
            try { a(function(a) { q(b, a) }, function(a) { r(b, a) }) } catch (c) { r(b, c) }
        }
        var p = 2;
                ...
                if (a.a != p)
                    for (; a.f.length;) {
                        var b = a.f.shift(),
                            ...
                            e = b[2],
                            b = b[3];
                        try { 0 == a.a ? "function" == typeof c ? e(c.call(void 0, a.b)) : e(a.b) : 1 == a.a && ("function" == typeof d ? e(d.call(void 0, a.b)) : b(a.b)) } catch (h) { b(h) }
                    }
            })
        }
    ...
    (function() {
        function aa(a) { return a.map(function(a) { return "U+" + a.toString(16) }).join(",") }
        ...
        function r(a) { for (var b = {}, c = 0; c < a.b.length; c++) b[a.b[c]] = a.b[c]; return Object.keys(b).map(function(a) { return b[a] }).sort(function(a, b) { return a - b }) }

        function fa(a, b) { for (var c = {}, d = new m, e = 0; e < a.b.length; e++) c[a.b[e]] = !0; for (e = 0; e < b.b.length; e++) c[b.b[e]] || d.b.push(b.b[e]); return d }
                ...
                a: {
                    ...
                    for (var b = "", c = [], d = 0; d < a.length; d++) {
                        ...
                        if ("'" === e || '"' === e) {
                            b = d + 1;
                            do
                                if (b = a.indexOf(e, b) + 1, !b) { a = null; break a }
                            while ("\\" === a.charAt(b - 2));
        ...
        function ha(a) {
            ...
            var b = [];
            do { var c = a.currentNode; if (c && "SCRIPT" !== c.nodeName && "STYLE" !== c.nodeName && "NOSCRIPT" !== c.nodeName && "TEMPLATE" !== c.nodeName && "LINK" !== c.nodeName && "TITLE" !== c.nodeName) { for (var d = c.childNodes, e = 0; e < d.length; e++) d[e].nodeType !== Node.TEXT_NODE || /^\s*$/.test(d[e].nodeValue) || b.push(d[e].nodeValue); "INPUT" === c.nodeName && "hidden" !== c.type && "password" !== c.type && b.push(c.value); "TEXTAREA" === c.nodeName && b.push(c.value) } } while (a.nextNode());
            a = b.join("");
            b = new m;
        ...
        ia.prototype.g = function(a) { a.target && (a = a.target, 3 === a.nodeType && (a = a.parentNode), this.m([a])) };

        function ka(a) { ja ? a.i.observe(a.b, { attributes: !0, characterData: !0, subtree: !0, childList: !0 }) : (a.b.addEventListener("DOMAttrModified", a.g.bind(a), !1), a.b.addEventListener("DOMNodeInserted", a.g.bind(a), !1), a.b.addEventListener("DOMCharacterDataModified", a.g.bind(a), !1)) };
        ...
        function la(a) {
            ...
            this.b = new ia(b, function(b) {
                var d = [];
                b.forEach(function(a) { ha(a).forEach(function(a) { c.cache[a] || (d.push(a), c.cache[a] = !0) }) });
                d.length && a(d)
            })
        };
        ...
        function D(a, b) { return "wf-" + a.family + "-" + qa(a) + "-" + b }

        function C(a, b, c) {
            if (a.g[b]) try {
                if (c) a.g[b](c.family, qa(c));
                else a.g[b]()
            } catch (d) { console.error('Typekit: Error in "' + b + '" callback', d) }
        };
        ...
        function ta(a) {
            var b = [];
            Object.keys(a.b).forEach(function(c) { a.b[c] && b.push(c) });
            return b
        }
        ...
        function E(a, b) { return a.b.replace(/\{([^\{\}]+)\}/g, function(a, d) { if ("?" == d.charAt(0)) { for (var c = d.slice(1).split(","), f = [], h = 0; h < c.length; h++) b[c[h]] && f.push(c[h] + "=" + encodeURIComponent(b[c[h]])); return f.length ? "?" + f.join("&") : "" } return encodeURIComponent(b[d] || "") }) };

        function B(a, b) {-1 === a.className.split(/\s+/).indexOf(b) && (a.className += " " + b) }
        ...
        function wa(a, b) { document.addEventListener ? a.addEventListener("scroll", b, !1) : a.attachEvent("scroll", b) }

        function xa(a) {
            document.body ? a() : document.addEventListener ? document.addEventListener("DOMContentLoaded", function c() {
                document.removeEventListener("DOMContentLoaded", c);
                a()
            }) : document.attachEvent("onreadystatechange", function d() { if ("interactive" == document.readyState || "complete" == document.readyState) document.detachEvent("onreadystatechange", d), a() })
        };
        ...
        function F(a, b) { a.b.style.cssText = "max-width:none;min-width:20px;min-height:20px;display:inline-block;overflow:hidden;position:absolute;width:auto;margin:0;padding:0;top:-999px;left:-999px;white-space:nowrap;font-synthesis:none;font:" + b + ";" }
        ...
        function Ha() { null === Fa && (Fa = !!document.fonts); return Fa }
        ...
        function G(a, b) { return [a.style, a.weight, Ia() ? a.stretch : "", "100px", b].join(" ") }
            ...
            return new Promise(function(a, b) {
                if (Ha() && !Ga()) {
                    var g = new Promise(function(a, b) {
                            function e() {
                                (new Date).getTime() - h >= f ? b() : document.fonts.load(G(c, '"' + c.family + '"'), d).then(function(b) { 1 <= b.length ? a() : setTimeout(e, 25) }, function() { b() })
                            }
                            e()
                        }),
                        l = new Promise(function(a, b) { e = setTimeout(b, f) });
        ...
        function Ka() {
            if (!Ja) {
                ...
                Ja = (new Ba("_fff_", {})).load("@", 5E3).then(function() {
                    ...
                    return d
                }, function() { return ["opentype", "truetype"] })
            }
            return Ja
        };

        function La(a) { for (var b = /\burl\((\'|\"|)([^\'\"]+?)\1\)( format\((\'|\"|)([^\'\"]+?)\4\))?/g, c, d = []; c = b.exec(a);) c[2] && d.push({ url: c[2], format: c[5] }); return d };
        ...
        Ma.prototype.arrayBuffer = function() { return Promise.resolve(this.body) };
        ...
        function Oa(a) {
            ...
            return new Promise(function(c, d) {
                if (Na) {
                    ...
                    e.onload = function() { c(new Ma(e.response, { status: e.status, statusText: e.statusText })) };
                    e.onerror = function() { d(new TypeError("Network request failed")) };
                    e.open("GET", a);
                    e.responseType = "arraybuffer";
                    b && Object.keys(b).forEach(function(a) { e.setRequestHeader(a, b[a]) });
                    e.send(null)
                } else e = new XDomainRequest, e.open("GET", a.replace(/^http(s)?:/i, window.location.protocol)), e.ontimeout = function() { return !0 }, e.onprogress = function() { return !0 },
                    e.onload = function() { c(new Ma(e.responseText, { status: e.status, statusText: e.statusText })) }, e.onerror = function() { d(new TypeError("Network request failed")) }, setTimeout(function() { e.send(null) }, 0)
            })
        };
        ...
        function Pa(a, b, c) {
            ...
            Object.defineProperties(this, {
                family: { get: function() { return a } },
                style: { get: function() { return e.style || "normal" } },
                weight: { get: function() { return e.weight || "normal" } },
                stretch: { get: function() { return e.stretch || "normal" } },
                display: { get: function() { return e.display || "auto" } },
                unicodeRange: { get: function() { return e.unicodeRange || "U+0-10FFFF" } },
                variant: {
                    get: function() {
                        return e.variant ||
                            "normal"
                ...
                featureSettings: { get: function() { return e.featureSettings || "normal" } },
                status: { get: function() { return this.o } },
                loaded: { get: function() { return this.G } }
            });
        ...
        function Qa(a, b) {
            for (var c = null, d = 0; d < b.length; d++)
                for (var e = 0; e < a.b.length; e++)
                    if (b[d] === a.b[e].format && null === c) { c = a.b[e].url; break }!c && b.length && (c = a.b[0].url);
            return c
        }
        Pa.prototype.load = function() {
            var a = this;
            "unloaded" === a.o && (a.o = "loading", Ka().then(function(b) {
                (b = Qa(a, b)) ? Oa(b).then(function(a) { if (a.ok) return a.arrayBuffer(); throw a; }).then(function(b) {
                    a.i = b;
                    a.o = "loaded";
                    a.A(a)
                })["catch"](function() {
        ...
        function I() {
            this.fonts = [];
            this.o = "loaded";
            Object.defineProperties(this, { status: { get: function() { return this.o } }, size: { get: function() { return this.fonts.length } } })
        }
        ...
        I.prototype.clear = function() { this.fonts = [] };
        I.prototype.has = function(a) { return -1 !== this.fonts.indexOf(a) };
        I.prototype.forEach = function(a) {
            var b = this;
            this.fonts.forEach(function(c, d) { a(c, d, b) })
        };

        function Ra(a, b) {
            function c(a) { return "bold" === a ? 700 : "normal" === a ? 400 : a }
            var d = ga(b);
        ...
        I.prototype.load = function(a) {
            var b = this,
                c = Ra(this, a);
            return c ? c.length ? (b.o = "loading", Promise.all(c.map(function(a) { return a.load() })).then(function() { b.o = "loaded"; return c })["catch"](function() { b.o = "loaded"; return c })) : Promise.resolve([]) : Promise.reject([])
        };
        ...
        function L(a, b) { return (a & 65535) * b + (((a >>> 16) * b & 65535) << 16) }
        ...
        Ua.prototype.has = function(a) { if (Math.floor(a / 32 + 1) > this.b.length) throw Error("Index is out of bounds."); var b = Math.floor(a / 32); return !!(this.b[b] & 1 << a - 32 * b) };
        ...
        Va.prototype.add = function(a) { if ("string" !== typeof a && "number" !== typeof a) throw Error("Value should be a string or number."); for (var b = "number" === typeof a, c = 0; c < this.g; c++) this.b.set(b ? Sa(a, M[c]) % this.size : Ta(a, M[c]) % this.size) };
        ...
        function Xa(a) {
            if (a.unicode.length) {
                ...
                a.unicode.forEach(function(a) { c.add(a) });
                return Wa(c)
            }
            return "AAAAAQAAAAEAAAAB"
        }

        function Ya(a) { return a.g.length ? a.g.map(function(a) { return a.trim() }).join(",") : "NONE" };
        ...
        function O(a, b) { return b >>> a | b << 32 - a }

        function $a(a) { return 4294967296 * (a - Math.floor(a)) | 0 }

        function P(a) { for (var b = "", c, d = 7; 0 <= d; d--) c = a >>> 4 * d & 15, b += c.toString(16); return b };
        ...
        function Q(a, b) {
            return new Promise(function(c, d) {
                ...
                if (ab) {
                    ...
                    f.onload = function() { c({ body: f.response, status: f.status, statusText: f.statusText }) };
                    f.onerror = function() { d(Error("Network request failed")) };
                    f.open(e.method, a, !0);
                    f.responseType = "arraybuffer";
                    e.headers && Object.keys(e.headers).forEach(function(a) { f.setRequestHeader(a, e.headers[a]) });
                    f.send(e.body)
                } else f = new XDomainRequest, f.open(e.method, a.replace(/^http(s)?:/i, window.location.protocol)),
                    f.ontimeout = function() { return !0 }, f.onprogress = function() { return !0 }, f.onload = function() { c({ body: null, status: f.status, statusText: f.statusText }) }, f.onerror = function() { d(Error("Network request failed")) }, setTimeout(function() { f.send(e.body) }, 0)
            })
        };
        ...
        function db(a) {
            ...
            cb[b] || (cb[b] = Q(E(c, { primer: eb(a) }), { method: "POST", headers: { "Content-Type": "application/x-www-form-urlencoded" }, body: fb(a) }).then(function() { return b }));
            return cb[b]
        }
        ...
        function hb(a) { return a.i.length ? a.i.map(function(a) { return a.trim() }).join(",") : "NONE" }

        function fb(a) { var b = "version=1.0&unicode=" + encodeURIComponent(a.unicode.join(",")); return b = a.b ? b + ("&dyna=" + encodeURIComponent(gb(a))) : b + ("&features=" + encodeURIComponent(hb(a))) }

        function eb(a) {
            if (null === a.g) {
                var b = { version: "1.0", unicode: a.unicode.join(",") };
                a.b ? b.dyna = gb(a) : b.features = hb(a);
                for (var c = new Za, d = JSON.stringify(b), b = c.g.slice(0), c = c.b.slice(0), d = d + String.fromCharCode(128), e = Math.ceil((d.length / 4 + 2) / 16), f = Array(e), h = 0; h < e; h++) { f[h] = Array(16); for (var g = 0; 16 > g; g++) f[h][g] = d.charCodeAt(64 * h + 4 * g) << 24 | d.charCodeAt(64 * h + 4 * g + 1) << 16 | d.charCodeAt(64 * h + 4 * g + 2) << 8 | d.charCodeAt(64 * h + 4 * g + 3) }
        ...
        var jb = { u: 1, read: function(a, b) { return a.getUint8(b || 0) } },
            S = { u: 2, read: function(a, b) { return a.getUint16(b || 0) } },
            T = { u: 4, read: function(a, b) { return a.getUint32(b || 0) } },
            kb = { u: 4, read: function(a, b) { return a.getUint32(b || 0) } };

        function U(a) { return a % 4 ? a + (4 - a % 4) : a }
        ...
        function lb(a) { for (var b = new Uint32Array(4), c = 0; c < a.byteLength; c += 4) b[0] += a.getUint32(c); return b[0] };
        var X = W({ type: T, I: S, C: S, i: S, A: S }),
            Y = W({ tag: kb, b: T, offset: T, length: T });
        ...
        var sb = W({ tag: kb, g: T, offset: T, length: T }),
            tb = W({ tag: kb, K: jb, m: T, H: S }),
            ub = W({ type: jb, offset: T, length: T });
        ...
        function wb(a, b, c) {
            ...
            this.b = null;
            Object.defineProperties(this, {
                family: { get: function() { return this.w.family.replace(/['"]/g, "") } },
                style: { get: function() { return this.w.style } },
                weight: { get: function() { return this.w.weight } },
                stretch: { get: function() { return this.w.stretch } },
                display: { get: function() { return this.w.display } },
                unicodeRange: { get: function() { var a = r(this.unicode); return a.length ? aa(a) : "U+10ffff" } },
                featureSettings: { get: function() { return this.w.featureSettings } },
                status: { get: function() { return this.o } },
                dynamic: { get: function() { return d.dynamic || !1 } }
            });
            this.i = Promise.resolve(this);
            this.m = []
        }

        function yb(a) { return { style: a.style, weight: a.weight, stretch: a.stretch, unicodeRange: a.unicodeRange, display: a.display } }

        function qa(a) { var b = a.weight; return a.style[0] + ("b" === b[0] ? "7" : "n" === b[0] ? "4" : b[0]) }
        ...
        function zb(a, b) {
            ...
            if (4096 >= c.length) return Q(c).then(function(a) { if (200 === a.status) return a.body; throw a; });
            var d = null,
                d = b.b ? new bb(b.unicode, null, a.b.b[1146703425]) : new bb(b.unicode, b.g),
                c = eb(d),
                e = E(a.url, { format: "m", primer: c });
            return Q(e).then(function(a) { return 200 === a.status ? a.body : db(d).then(function() { return Q(e).then(function(a) { if (200 === a.status) return a.body; throw a; }) }) })
        }
                        ...
                        if (b.b instanceof mb) {
                            ...
                            return zb(b, c).then(function(d) {
                                ...
                                if (0 === d.status) return nb(a, d), b.subset =
                                    c, b.b = a, b.w = new J(b.family, (new DataView(b.b.arrayBuffer)).buffer, yb(b)), b.w.load().then(function() { K.add(b.w); return b });
                                b.subset = c;
                                return b
                            })
                        }
        ...
        function Z() {
            ...
            Object.defineProperties(this, {
                ...
                size: { get: function() { return this.fonts.length } }
            })
        }
        Z.prototype.has = function(a) { return -1 !== this.fonts.indexOf(a) };
        Z.prototype.add = function(a) { this.has(a) || (K.add(a.w), this.fonts.push(a)); return this };
        Z.prototype["delete"] = function(a) { var b = this.fonts.indexOf(a); - 1 !== b && this.fonts.splice(b, 1); return K["delete"](a.w) };
        ...
        function Bb(a, b) { b.length && Q(E(a.url, { s: a.i, k: a.A, ht: a.g, h: a.m, f: b.join("."), a: a.b, js: a.version, app: a.app, e: "js", _: Date.now() })) };
        ...
        Cb.prototype.set = function(a) { this.g = x(this.g, a) };
        Cb.prototype.get = function() { return x(this.b, this.g) };
        ...
        function Db(a) {
            ...
            this.ping = new Ab(a);
            this.b = a.c;
            a.f && (a.f.forEach(function(a) { this.B.push(new wb(a.family, a.source, a.descriptors)) }, this), a.ping && Bb(this.ping, a.f.map(function(a) { return a.id })))
        }

        function Eb(a) { a.B.forEach(function(b) { b.dynamic && b.update(aa(r(a.cache.get()))) }) }
        ...
        Db.prototype.load = function(a) {
            ...
            xa(function() {
                ...
                Promise.all(b.B.map(function(a) { pa(c, a); return a.dynamic ? a.update(aa(r(b.cache.get()))).then(function() { return a.load() })["catch"](function(b) { oa(c, a); throw b; }) : a.load()["catch"](function(b) { oa(c, a); throw b; }) })).then(function() {
                    b.B.map(function(a) {
                        z(c.b, D(a, "loading"));
                        B(c.b, D(a, "active"));
                        C(c, "fontactive", a);
...
}({ "a": "10381944", "h": "tk", "t": "gra8aww", "p": 1, "j": "1.6.1", "c": [".tk-source-sans-pro", "\"source-sans-pro\",sans-serif", ".tk-source-han-sans-japanese", "\"source-han-sans-japanese\",sans-serif", ".tk-source-han-sans-cjk-ja", "\"source-han-sans-cjk-ja\",sans-serif"], "l": "typekit", "type": "dynamic", "preview": "https://use.typekit.net/pf/{user}/{font_alias}/{fvd}/{format}{?subset_id,primer,token,unicode,features,gdyn,v}", "ping": "https://p.typekit.net/p.gif{?s,k,ht,h,f,a,js,app,e,_}", "primer": "https://primer.typekit.net/primer/{primer}", "f": [{ "source": "https://use.typekit.net/af/61f808/00000000000000003b9b3d63/27/{format}{?primer,unicode,gdyn,features,v}", "id": 17265, "dynamic": false, "family": "source-sans-pro", "descriptors": { "display": "auto", "unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2BC,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122", "featureSettings": "\"ALL \"", "subset": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191" } }, { "source": "https://use.typekit.net/af/422d60/00000000000000003b9b3d67/27/{format}{?primer,unicode,gdyn,features,v}", "id": 17267, "dynamic": false, "family": "source-sans-pro", "descriptors": { "weight": 700, "display": "auto", "unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2BC,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122", "featureSettings": "\"ALL \"", "subset": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191" } }, { "source": "https://use.typekit.net/af/9373a0/00000000000000003b9b3d68/27/{format}{?primer,unicode,gdyn,features,v}", "id": 17268, "dynamic": false, "family": "source-sans-pro", "descriptors": { "weight": 700, "style": "italic", "display": "auto", "unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2BC,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122", "featureSettings": "\"ALL \"", "subset": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191" } }, { "source": "https://use.typekit.net/af/ffb1e2/00000000000000003b9b3d64/27/{format}{?primer,unicode,gdyn,features,v}", "id": 17269, "dynamic": false, "family": "source-sans-pro", "descriptors": { "style": "italic", "display": "auto", "unicodeRange": "U+20-7E,U+A0-FF,U+152-153,U+178,U+2BC,U+2DC,U+2013-2014,U+2018-2019,U+201C-201E,U+2022,U+2026,U+2039-203A,U+20AC,U+2122", "featureSettings": "\"ALL \"", "subset": "7cdcb44be4a7db8877ffa5c0007b8dd865b3bbc383831fe2ea177f62257a9191" } }, { "source": "https://use.typekit.net/af/cc637a/00000000000000007735de0a/30/{format}{?primer,unicode,gdyn,features,v}", "id": 23591, "dynamic": true, "family": "source-han-sans-japanese", "descriptors": { "weight": 700, "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }, { "source": "https://use.typekit.net/af/eb6599/00000000000000007735de09/30/{format}{?primer,unicode,gdyn,features,v}", "id": 23593, "dynamic": true, "family": "source-han-sans-japanese", "descriptors": { "weight": 900, "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }, { "source": "https://use.typekit.net/af/7e8037/00000000000000007735de07/30/{format}{?primer,unicode,gdyn,features,v}", "id": 23596, "dynamic": true, "family": "source-han-sans-japanese", "descriptors": { "weight": 300, "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }, { "source": "https://use.typekit.net/af/f55f81/00000000000000007735de06/30/{format}{?primer,unicode,gdyn,features,v}", "id": 23597, "dynamic": true, "family": "source-han-sans-japanese", "descriptors": { "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }, { "source": "https://use.typekit.net/af/469a04/00000000000000007735de10/30/{format}{?primer,unicode,gdyn,features,v}", "id": 41306, "dynamic": true, "family": "source-han-sans-cjk-ja", "descriptors": { "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }, { "source": "https://use.typekit.net/af/844134/00000000000000007735de0e/30/{format}{?primer,unicode,gdyn,features,v}", "id": 41308, "dynamic": true, "family": "source-han-sans-cjk-ja", "descriptors": { "weight": 700, "display": "auto", "featureSettings": "\"ALL \"", "subset": "", "dynamic": true } }] }))