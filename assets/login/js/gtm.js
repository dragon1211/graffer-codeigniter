...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_dimension":["list",["map","index","1","dimension",["macro",1]],["map","index","3","dimension",["macro",2]],["map","index","13","dimension",["macro",3]],["map","index","14","dimension",["macro",4]],["map","index","15","dimension",["macro",5]],["map","index","16","dimension",["macro",6]]],
      ...
      "vtp_decorateFormsAutoLink":false,
      "vtp_enableLinkId":true,
      "vtp_dimension":["list",["map","index","2","dimension",["macro",9]],["map","index","3","dimension",["macro",2]],["map","index","11","dimension",["macro",10]],["map","index","12","dimension",["macro",11]],["map","index","13","dimension",["macro",12]],["map","index","14","dimension",["macro",13]],["map","index","15","dimension",["macro",14]]],
      "vtp_enableEcommerce":false,
  ...
  "rules":[
    ...
    [["if",33],["add",28]],
    [["if",34],["add",29]],
    [["if",10,35,36,37],["add",30]],
    [["if",10,36,38,39],["add",31]],
    [["if",40],["add",32]],
    [["if",41],["add",33]],
    [["if",1,36,42],["add",34]],
    [["if",36,43,44],["add",35]],
    ...
    [["if",66],["add",54]],
    [["if",67],["add",55]],
    [["if",68],["add",56,58,59,60,61,62,63,64,67,68,69]],
    [["if",68,69],["add",57]],
    [["if",68,70,71],["add",65,66]]]
},
"runtime":[]
...
(void 0===m[a]||c&&!m[a])&&(m[a]=b);return m[a]},oo=function(a,b,c){return If(a,b,void 0===c?!0:!!c)},po=function(a,b,c){return 0===Rf(a,b,c)},qo=function(a,b){if(Fh()){b&&E(b)}else Gb(a,b)},ro=function(a){return!!Lm(a,"init",!1)},so=function(a){Jm(a,"init",!0)},to=function(a){var b=ef+"?id="+encodeURIComponent(a)+"&l=dataLayer";R(Hh("https://","http://",b))},uo=function(a,b,c){vj&&(Vb(a)||Bj(c,b,a))};
var vo=Sn.Xh;function So(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var To=new Ha;function Uo(a,b,c){var d=c?"i":void 0;try{var e=String(b)+d,f=To.get(e);f||(f=new RegExp(b,d),To.set(e,f));return f.test(a)}catch(h){return!1}}
...
function Tr(a,b){}var Z={g:{}};Z.g.ctv=["google"],function(){(function(a){Z.__ctv=a;Z.__ctv.h="ctv";Z.__ctv.m=!0;Z.__ctv.priorityOverride=0})(function(){return"46"})}();
...
Z.g.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:io()}function b(f,h){Ib(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:ko(l),X:jo(l)})})}function c(f,h){Ib(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:ko(l),X:jo(l)})})}function d(f,h,k){var l=h.history,n=l[f];if(wa(n))try{l[f]=function(q,p,r){n.apply(l,[].slice.call(arguments,0));k({source:f,state:q,url:ko(io()),
X:jo(io())})}}catch(q){}}function e(){var f={source:null,state:V("history").state||null,url:ko(io()),X:jo(io())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.X!=h.X){var n={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.X,"gtm.newUrlFragment":h.X,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;mo(n)}}}(function(f){Z.__hl=f;Z.__hl.h="hl";Z.__hl.m=!0;Z.__hl.priorityOverride=
0})(function(f){var h=V("self");if(!ro("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);so("hl")}E(f.vtp_gtmOnSuccess)})}();
...
[];k.firstChild;)p.push(k.removeChild(k.firstChild));d.insertBefore(k,null);a(k,p,l,h)()}else d.insertBefore(k,null),l()}else f()}catch(r){E(h)}}}var b=function(d,e,f){ni(function(){var h=google_tag_manager_external.postscribe.getPostscribe(),k={done:e},l=B.createElement("div");l.style.display="none";l.style.visibility="hidden";B.body.appendChild(l);try{h(l,d,k)}catch(n){E(f)}})};var c=function(d){if(B.body){var e=
